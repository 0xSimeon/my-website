<template>
  <section class="py-10 pb-32 px-8 sm:px-4 sm:py-4 w-full about" id="About">
    <h2
      class="mt-16 sm:ml-0 px-4 sm:px-1 py-6 sm:text-4xl font-bold text-5xl font-headingFont about__heading"
    >
      A bit about me...
    </h2>
